...
for i in range(len(all_data)):    
    ...
    avg_lap_time_reg = pd.to_datetime(analysis_df['sector_3'], format="%S.%f").mean()
    ...
    plt.savefig(f'/home/boris/Documents/matplotlib_exercize/LE_MANS_2024/LE_MANS_2024_Sector_3/{analysis_df.loc[0, "driver_name"]}_sector_3.jpg')
    plt.close()