...
race = 'DEUTCHLAND'
season = '2024'
if not os.path.isdir(f'{race}_{season}_MOTO_3'):
    os.mkdir(f'{race}_{season}_MOTO_3')
if not os.path.isdir(f'{race}_{season}_MOTO_3/{race}_{season}_Analysis'):
    os.mkdir(f'{race}_{season}_MOTO_3/{race}_{season}_Analysis')


if not os.path.isdir(f'{race}_{season}_MOTO_3/{race}_{season}_Sector_1'):
    os.mkdir(f'{race}_{season}_MOTO_3/{race}_{season}_Sector_1')

if not os.path.isdir(f'{race}_{season}_MOTO_3/{race}_{season}_Sector_2'):
    os.mkdir(f'{race}_{season}_MOTO_3/{race}_{season}_Sector_2')

if not os.path.isdir(f'{race}_{season}_MOTO_3/{race}_{season}_Sector_3'):
    os.mkdir(f'{race}_{season}_MOTO_3/{race}_{season}_Sector_3')

if not os.path.isdir(f'{race}_{season}_MOTO_3/{race}_{season}_Sector_4'):
    os.mkdir(f'{race}_{season}_MOTO_3/{race}_{season}_Sector_4')
...
for i in range(len(all_data)):    
    ...
    if not analysis_df.empty:
        ...
        plt.savefig(f'/home/boris/Documents/matplotlib_exercize/{race}_{season}_MOTO_3/{race}_{season}_Analysis/{analysis_df.loc[0, "driver_name"]}_analysis.jpg')
        plt.close()
...
for i in range(len(all_data)):    
    ...
    if not analysis_df.empty:
        ...
        plt.tight_layout()
        plt.legend(loc='upper left', fontsize=15)
        plt.savefig(f'/home/boris/Documents/matplotlib_exercize/{race}_{season}_MOTO_3/{race}_{season}_Sector_1/{analysis_df.loc[0, "driver_name"]}_sector_1.jpg')
        plt.close()
...
for i in range(len(all_data)):    
    ...
    if not analysis_df.empty:
        ...
        plt.tight_layout()
        plt.legend(loc='upper left', fontsize=15)
        plt.savefig(f'/home/boris/Documents/matplotlib_exercize/{race}_{season}_MOTO_3/{race}_{season}_Sector_2/{analysis_df.loc[0, "driver_name"]}_sector_2.jpg')
        plt.close()
...
for i in range(len(all_data)):    
    ...
    if not analysis_df.empty:
        ...
        plt.tight_layout()
        plt.legend(loc='upper left', fontsize=15)
        plt.savefig(f'/home/boris/Documents/matplotlib_exercize/{race}_{season}_MOTO_3/{race}_{season}_Sector_3/{analysis_df.loc[0, "driver_name"]}_sector_3.jpg')
        plt.close()
...
for i in range(len(all_data)):    
    ...
    if not analysis_df.empty:
        ...
        plt.tight_layout()
        plt.legend(loc='upper left', fontsize=15)
        plt.savefig(f'/home/boris/Documents/matplotlib_exercize/{race}_{season}_MOTO_3/{race}_{season}_Sector_4/{analysis_df.loc[0, "driver_name"]}_sector_4.jpg')
        plt.close()
...
plt.savefig(f'/home/boris/Documents/matplotlib_exercize/{race}_{season}_MOTO_3/{race}_Fastest_Lap_By_lap.jpg')
...
plt.tight_layout()
ax.legend(handles=[l], loc=(0,-0.08), fontsize=13)
plt.savefig(f'/home/boris/Documents/matplotlib_exercize/{race}_{season}_MOTO_3/{race}_Fastest_Speed_By_lap.jpg')
